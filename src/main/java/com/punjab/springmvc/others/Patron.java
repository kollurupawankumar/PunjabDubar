...
public class Patron {
  ...
  public static Patron find(int searchId) {
    try (Connection con = DB.sql2o.open()) {
      String sql = "SELECT id as mId, first_name AS mFirstName, last_name as mLastName, phone as mPhone, is_active as mIsActive FROM dumdar.patrons WHERE id = :id";
  ...
  public static List<Patron> all() {
    try (Connection con = DB.sql2o.open()) {
      String sql = "SELECT id as mId, first_name AS mFirstName, last_name as mLastName, phone as mPhone, is_active as mIsActive FROM dumdar.patrons";
      return con.createQuery(sql)
  ...
  public void save() {
    try (Connection con = DB.sql2o.open()) {
      String sql = "INSERT INTO dumdar.patrons (first_name, last_name, phone, is_active) VALUES (:first, :last, :phone, :isactive)";
  ...
  public void updateFirstName(String newFirst) {
    try (Connection con = DB.sql2o.open()) {
      String sql = "UPDATE dumdar.patrons SET first_name = :newfirst WHERE id = :id";
      con.createQuery(sql)
  ...
  public void updateLastName(String newLast) {
    try (Connection con = DB.sql2o.open()) {
      String sql = "UPDATE dumdar.patrons SET last_name = :newlast WHERE id = :id";
      con.createQuery(sql)
  ...
  public void updatePhone(String newPhone) {
    try (Connection con = DB.sql2o.open()) {
      String sql = "UPDATE dumdar.patrons SET phone = :newphone WHERE id = :id";
      con.createQuery(sql)
  ...
  public void setIsActive(boolean active) {
    try (Connection con = DB.sql2o.open()) {
      String sql = "UPDATE dumdar.patrons SET is_active = :active WHERE id = :id";
      con.createQuery(sql)
