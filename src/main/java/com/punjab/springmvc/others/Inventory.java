...
public class Inventory {
  ...
  public int getCurrentOnHand() {
    try (Connection con = DB.sql2o.open()) {
      String sql = "SELECT current_on_hand FROM dumdar.inventories WHERE id = :id";
  ...
  public String getExpirationDate() {
    try (Connection con = DB.sql2o.open()) {
      String sql = "SELECT expiration_date FROM dumdar.inventories WHERE id = :id";
      return con.createQuery(sql)
        .addParameter("id", mId)
  ...
  public int getShelfLifeDays() {
    try (Connection con = DB.sql2o.open()) {
      String sql = "SELECT ingredients.shelf_life_days AS mShelfLifeDays FROM dumdar.ingredients WHERE ingredients.id = :id";
      return con.createQuery(sql)
  ...
  public void save() {
    try (Connection con = DB.sql2o.open()) {
      String sql = "INSERT INTO dumdar.inventories (ingredient_id, current_on_hand, delivery_date, expiration_date) VALUES (:ingredient_id, :current_on_hand, TO_DATE(:delivery_date, 'yyyy-mm-dd'), TO_DATE(:expiration_date, 'yyyy-mm-dd'))";
  ...
  public static Inventory find(int inventoryId) {
    try (Connection con = DB.sql2o.open()) {
      String sql = "SELECT id AS mId, ingredient_id AS mIngredientId, current_on_hand AS mCurrentOnHand, delivery_date AS mDeliveryDate, expiration_date AS mExpirationDate FROM dumdar.inventories WHERE id = :id";
      return con.createQuery(sql)
  ...
  public static List<Inventory> all() {
    try (Connection con = DB.sql2o.open()) {
      String sql = "SELECT id AS mId, ingredient_id AS mIngredientId, current_on_hand AS mCurrentOnHand, delivery_date AS mDeliveryDate, expiration_date AS mExpirationDate FROM dumdar.inventories";
  ...
  public void delete() {
    try (Connection con = DB.sql2o.open()) {
      String sql = "DELETE FROM dumdar.inventories WHERE id = :id";
      con.createQuery(sql)
        .addParameter("id", mId)
        .executeUpdate();
    }
  ...
  public void update(int currentOnHand) {
    try (Connection con = DB.sql2o.open()) {
      String sql = "UPDATE dumdar.inventories SET current_on_hand = :current_on_hand WHERE id = :id";
      con.createQuery(sql)
  ...
  public void updateExpiration(String newExpirationDate) {
    try (Connection con = DB.sql2o.open()) {
      String sql = "UPDATE dumdar.inventories SET expiration_date = TO_DATE(:expiration_date, 'yyyy-mm-dd') WHERE id = :id";
      con.createQuery(sql)
  ...
  public List<Ingredient> getIngredients() {
    try (Connection con = DB.sql2o.open()) {
      String sql = "SELECT ingredients.id AS mId, ingredients.name AS mName, ingredients.unit AS mUnit, ingredients.desired_on_hand AS mDesiredOnHand, ingredients.shelf_life_days AS mShelfLifeDays FROM dumdar.ingredients INNER JOIN inventories ON (ingredients.id = inventories.ingredient_id) ORDER BY ingredients.name";
